var myapp_config = {
    ...
    isWebkit: !0 == (!!window.chrome && !!window.chrome.webstore) || Object.prototype.toString.call(window.HTMLElement).indexOf("Constructor") > 0 == !0,
 ...
 !(function (e) {
    e.fn.extend({
        navigation: function (o) {
            var t = e.extend({ accordion: !0, animate: "easeOutExpo", speed: 200, closedSign: "[+]", openedSign: "[-]", initClass: "js-nav-built" }, o),
                n = e(this);
            n.hasClass(t.initClass)
                ? myapp_config.debugState && console.log(n.get(0) + " this menu already exists")
                : (n.addClass(t.initClass),
                  ...
                  n.find("li.active").each(function () {
                      e(this).parents("ul").parent("li").find("a:first").attr("aria-expanded", !0).find("b:first").html(t.openedSign);
                  }),
                                  ...
                                  visible.each(function (o) {
                                      ...
                                      parents.each(function (e) {
                                          ...
                                          n &&
                                              ...
                                              e(visible[o]).slideUp(t.speed + 300, t.animate, function () {
                                                  e(this).parent("li").removeClass("open").find("a:first").attr("aria-expanded", !1).find("b:first").html(t.closedSign), myapp_config.debugState && console.log("nav item closed");
                                              });
                                  }))),
                          e(this).parent().find("ul:first").is(":visible") && !e(this).parent().find("ul:first").hasClass("active")
                              ? e(this)
                                    .parent()
                                    .find("ul:first")
                                    .slideUp(t.speed + 100, t.animate, function () {
                                        e(this).parent("li").removeClass("open").find("a:first").attr("aria-expanded", !1).find("b:first").delay(t.speed).html(t.closedSign), myapp_config.debugState && console.log("nav item closed");
                                    })
                              : e(this)
                                    .parent()
                                    .find("ul:first")
                                    .slideDown(t.speed, t.animate, function () {
                                        e(this).parent("li").addClass("open").find("a:first").attr("aria-expanded", !0).find("b:first").delay(t.speed).html(t.openedSign), myapp_config.debugState && console.log("nav item opened");
                                    }));
                  }));
        },
    ...
    (function (e) {
            ...
            return (
                ...
                (function () {
                    i.css("margin-left", "0px"),
                        i.wrap('<div id="' + n.wrapperId + '" class="nav-menu-wrapper d-flex flex-grow-1 width-0 overflow-hidden"></div>'),
                        e("#" + n.wrapperId).before(
                            '<a href="#" id="' + n.wrapperId + '-left-btn" class="d-flex align-items-center justify-content-center width-4 btn mt-1 mb-1 mr-2 ml-1 p-0 fs-xxl text-primary"><i class="fal fa-angle-left"></i></a>'
                        ),
                        e("#" + n.wrapperId).after(
                            '<a href="#" id="' + n.wrapperId + '-right-btn" class="d-flex align-items-center justify-content-center width-4 btn mt-1 mb-1 mr-1 ml-2 p-0 fs-xxl text-primary"><i class="fal fa-angle-right"></i></a>'
                        ),
                    ...
                    e("#" + n.wrapperId + "-left-btn").click(function (e) {
                        l(), t < 0 ? (r = Math.min(t + o, 0)) : ((r = t), console.log("left end")), i.css({ marginLeft: r }), e.preventDefault();
                    }),
                        e("#" + n.wrapperId + "-right-btn").click(function (e) {
                            l(), -t + o < a ? (r = Math.max(t - o, -(a - o))) : ((r = t), console.log("right end")), i.css({ marginLeft: r }), e.preventDefault();
                        }),
                        s("onInit");
                })(),
                {
                    ...
                    destroy: function (t) {
                        i.each(function () {
                            var t = e(this);
                            t.css("margin-left", "0px"), t.unwrap(parent), t.prev().off().remove(), t.next().off().remove(), s("onDestroy"), t.removeData("plugin_" + o);
                        });
                    },
                }
            );
        ...
        (e.fn[o] = function (n) {
            if ("string" == typeof arguments[0]) {
                ...
                return (
                    this.each(function () {
                        if (!e.data(this, "plugin_" + o) || "function" != typeof e.data(this, "plugin_" + o)[a]) throw new Error("Method " + a + " does not exist on jQuery." + o);
            ...
            if ("object" == typeof n || !n)
                return this.each(function () {
                    e.data(this, "plugin_" + o) || e.data(this, "plugin_" + o, new t(this, n));
                });
        }),
            (e.fn[o].defaults = { onInit: function () {}, onDestroy: function () {}, element: myapp_config.navHooks, wrapperId: myapp_config.navHorizontalWrapperId });
    })(jQuery);
                    ...
                    $(o)
                        .change(function () {
                            ...
                            return (
                                o.length > 1
                                    ? ($(e)
                                          .find($("[data-filter-tags]:not([data-filter-tags*='" + o + "'])"))
                                          .parentsUntil(e)
                                      ...
                                      t && t.text("showing " + $(e).find("li.js-filter-show").length + " from " + $(e).find("[data-filter-tags]").length + " total"))
                                    : ($(e).find("[data-filter-tags]").parentsUntil(e).removeClass("js-filter-hide js-filter-show"), t && t.text("")),
                                !1
                            );
                        })
                        .keyup(
                        ...
                        switch (!0) {
                            ...
                            case "panel-close" === o:
                                ...
                                "undefined" != typeof bootbox
                                    ? (initApp.playSound("media/sound", "messagebox"),
                                      bootbox.confirm({
                                          title:
                                              ...
                                              s.children(".panel-hdr").children("h2").text().trim() +
                                              "'&nbsp;</span>?",
                                    ...
                                    : confirm("Do you wish to delete panel " + s.children(".panel-hdr").children("h2").text().trim() + "?") && r();
                                break;
                            case "theme-update" === o:
